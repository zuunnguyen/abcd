...
In order to support loading of multiple wallets in smartblock-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is smartblock.cpp.
...
Changes to smartblock.cpp
----------------------
smartblock.cpp is the entry point into smartblock-qt, and as such, will require some minor modifications to provide hooks for
